...
| Doc | Contents | Closes |
|---|---|---|
| `../../spec/overview.md` — **DRAFTED v0.2** | Rewritten master spec: goals, threat model (incl. limitations — no formal proof post-D11, insider DoS, liveness dependence, PQ regression), layer diagram, normative-language conventions | G16, G17 |

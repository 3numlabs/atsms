...
import {
  encryptMessage,
  signMessage} from './crypto'
import {type ATProtoFacet,type ATSMSMessagePayload, type ATSMSTextContent, type ATSMSWebRTCContent} from './types'
 ...
 */
export function createTextContent(text: string, facets?: ATProtoFacet[]): string {
